...
export const fetchMortgagesData = async () => {
  // Remove any previously stored residential mortgage records so the
    ...
    try {
      ...
      for (const item of mortgages) {
        try {
          ...
          await ResidentialMortgage.findOneAndUpdate(
